  ...
  return (
    <>
      ...
      <div className="container my-5">
        <h2>My Cart</h2>
        {cart.items.map((item) => {
          const imgUrl = item.product?.image ? `${BACKEND_URL}${item.product.image}` : "/images/placeholder.png";
          return (
            <div key={item._id} className="d-flex align-items-center justify-content-between border p-3 mb-3">
